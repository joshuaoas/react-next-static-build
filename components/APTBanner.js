...
function APTBanner(props) {
    return (
        <>
            <div
                className="hero full-width-image-container margin-top-0 bg-center mb0 has-animated-waves waves-bottom waves-primary is-fullheight-with-navbar"

                style={{ backgroundImage: `url(/${props.featuredimage})`, backgroundPosition: 'center', position: 'relative', display: 'block' }}
            >
                ...
                <div className="animated-waves">
                    <svg className="waves" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 24 150 28" preserveAspectRatio="none" shapeRendering="auto">
                        ...
                        <g className="parallax">
                            <use xlinkHref="#gentle-wave" x={8} y={2} fill="rgba(255,255,255,0.7)" />
                            <use xlinkHref="#gentle-wave" x={0} y={10} fill="rgba(255,255,255,0.5)" />
                            <use xlinkHref="#gentle-wave" x={28} y={80} fill="rgba(255,255,255,0.3)" />
                            <use xlinkHref="#gentle-wave" x={38} y={10} fill="#fff" />
                        </g>
                    </svg>
                </div>
                                ...
                                <div className="column is-7 signup-column has-text-left">
                                    ...
                                    <div className="buttons">
                                        <a id="contact1" href={"tel:" + Global.contact.phone} className="button button-cta btn-align primary-btn z-index-2 scroll-link">
                                            <FaPhoneAlt /><span style={{ marginLeft: "5px" }}>{" "}{props.cta1title}</span>
                                        </a>
                                        <a id="contact2" href={props.cta2target} className="button button-cta btn-align z-index-2">
                                            <GrServices /><span style={{ marginLeft: "5px" }}>{" "}{props.cta2title}</span>
                                        </a>
                                    </div>
