...
function ContactOverview(props) {
    const listItems = props.sellingPoints.map((item, key) =>
        <div index={key} className="icon-group">
                        ...
                        <div className="columns is-vcentered">
                            <div className="column is-7">
                                <div className="side-feature-text">
                                    ...
                                    <div id="bodyCopy" dangerouslySetInnerHTML={{ __html: props.html }}></div>
                                    <p>{props.contentBody}</p>
                                    {/*
                                    <div className="button-wrap">
                                        <a href="kit2-signup.html" className="button button-cta btn-align raised primary-btn">
                                            Try it free
                                        </a>
                                    </div>
*/}
